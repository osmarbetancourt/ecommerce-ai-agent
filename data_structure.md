...
|-------------|----------|---------------------------|-----------------------------|
| id          | integer  | PK, NOT NULL, auto-incr   |                             |
| cart_id     | integer  | FK, NOT NULL              | References CART(id)         |
| product_id  | integer  | FK, NOT NULL              | References PRODUCT(id)      |
...
| id             | integer  | PK, NOT NULL, auto-incr   |                             |
| user_id        | integer  | FK                        | References USER(id)         |
| conversation_id| integer  | FK                        | References CONVERSATION(id) |
...
| id          | integer  | PK, NOT NULL, auto-incr   |                             |
| user_id     | integer  | FK                        | References USER(id)         |
| type_id     | integer  | FK                        | References PAYMENT_METHOD_TYPE(id) |
...
| user_id         | integer  | FK                        | References USER(id)         |
| order_id        | integer  | FK                        | References ORDER(id)        |
| payment_method_id| integer | FK                        | References PAYMENT_METHOD(id)|
